...
export default function InfoPanels({ data }: { data: any; }) {
  ...
  switch (props.variant) {
    ...
    case "grid-5": return <Grid5Variant {...props} />;
    ...
    case "horizontal-step": return <HorizontalStepVariant {...props} />;
    case "hub": return <HubVariant {...props} />;
    case "stepper": return <StepperVariant {...props} />;
    default:
