        ...
        {items.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              >
                <CardContent className="flex h-full flex-col items-center px-4 pb-6 pt-6 sm:px-6 sm:pb-8 sm:pt-8">
                  {/* Icône dans cercle avec gradient de l'item */}
                  {item.icon && (
                    <div
                      className={cn(
                        'mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full transition-all duration-300 sm:mb-6 sm:h-16 sm:w-16',
                  ...
                  <h3
                    className={cn(
                      'mb-3 text-lg font-semibold leading-tight transition-all duration-300 sm:mb-4 sm:text-xl',
                  ...
                  {item.desc && (
                    <p
                      className={cn(
                        'text-sm leading-relaxed transition-all duration-300 sm:text-base',
