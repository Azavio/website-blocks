...
export default function AccordionOutlineVariant({
  ...
  const defaultValue = defaultOpenFirst && filteredItems.length > 0 
    ...
    <div className={cn("relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8", className)}>
          ...
          <div className="mb-8 sm:mb-12">
            ...
            {searchTerm && (
              <div className="text-center text-sm text-muted-foreground mb-4">
                {filteredItems.length} {filteredItems.length === 1 ? 'question trouvée' : 'questions trouvées'}
              </div>
            )}
          </div>
        </ScrollAnimation>
      ...
      {tagFilter && allTags.length > 0 && (
        <ScrollAnimation animation="slideInUp" delay={0.1}>
          <div className="mb-8 sm:mb-12 flex flex-wrap gap-2 justify-center">
            <Button
              ...
              >
                ...
                >
                  ...
                  >
                    <div className="flex items-start gap-3 w-full pr-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {showTags && !tagFilter && item.tags && item.tags.length > 0 && (
                  ...
                  <AccordionContent className="pb-5 pt-2">
                    <div className={cn(
                      "text-sm sm:text-base leading-relaxed text-muted-foreground pl-8",
