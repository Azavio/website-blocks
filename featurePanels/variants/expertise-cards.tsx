        ...
        <div className="grid gap-6 sm:gap-8 lg:grid-cols-2">
          {cards.map((card, index) => {
            ...
            const cardColors = colorClasses(
              card.colorVariant ?? colorVariant ?? '',
            )
            const listColors = colorClasses(
              card.listColorVariant ?? colorVariant ?? '',
            )
                ...
                >
                  <CardHeader>
                    ...
                    {card.icon && (
                      <div
                        className={cn(
                          'mb-4 flex h-14 w-14 items-center justify-center rounded-full transition-all duration-300 sm:h-16 sm:w-16',
                          cardColors.accent,
                        )}
                      >
                        <Icon
                    ...
                    {card.buttons && (
                      <div className="flex flex-col gap-2">
                        ...
                        {card.buttons.primary && (
                          <Button
                            ...
                            className={cn(
                              ...
                              card.colorVariant &&
                                'bg-gradient-to-r hover:from-brand hover:to-brand-accent',
                            )}
                          >
                            {card.buttons.primary.href ? (
                              <a href={card.buttons.primary.href}>
                                ...
                                <Icon
                                  name={
                                    card.buttons.primary.icon || 'ArrowRight'
                                  }
                        ...
                        {card.buttons.secondary && (
                          <Button
                            variant={
                              card.buttons.secondary.variant || 'outline'
                            }
                          ...
                          >
                            {card.buttons.secondary.href ? (
                              <a href={card.buttons.secondary.href}>
                                ...
                                <Icon
                                  name={
                                    card.buttons.secondary.icon || 'ArrowRight'
                                  }
                                  className="ml-2 h-4 w-4"
                                />
                              </a>
