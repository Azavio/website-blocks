    ...
    <div className={cn("relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", className)}>
      ...
      <ScrollAnimation animation="slideInUp" delay={0.1}>
        <div className="hidden md:block">
          <div className={cn(
            "overflow-x-auto",
            responsive && "scrollbar-thin scrollbar-track-muted scrollbar-thumb-muted-foreground/20"
          )}>
            <table className={cn(
                    ...
                    {headerRow.cells.map((cell, cellIndex) => {
                      ...
                      return (
                        <th
                          key={cellIndex}
                          className={cn(
                            "border border-border p-3 sm:p-4 font-semibold",
                        ...
                        >
                          <div className="flex items-center gap-2 justify-center">
                            ...
                            <span className={cn(
                              cell.colorVariant && cellColors.textContentGradient
                            )}>
                              {cell.content}
                            </span>
                            {cell.badge && (
            ...
            >
              <div className={cn(
                ...
                <div className="mb-3 pb-3 border-b border-border">
                  <h3 className="font-semibold text-base flex items-center gap-2">
                    ...
                    {row.cells[0]?.badge && (
                      <Badge className={cn(
                        "text-xs",
                        row.cells[0]?.colorVariant ? colorClasses(row.cells[0].colorVariant).badge : "bg-muted text-muted-foreground border-muted"
                      )}>
                        {row.cells[0].badge}
                      </Badge>
                    )}
                ...
                <div className="space-y-3">
                  {headerRow && row.cells.slice(1).map((cell, cellIndex) => {
                ...
                {row.cells.some(cell => cell.metric || cell.improvement || cell.subtitle) && (
